...
/*
  ...
  This contract describes the frame-sequence hero, which the Dark Matter
  scene in PLAN.md replaces. It stays here until that scene lands, so the
  page is never running against an undocumented direction.
*/
