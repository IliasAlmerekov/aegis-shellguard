...
[![version](https://img.shields.io/badge/version-0.6.6-60A5FA?style=flat-square)](CHANGELOG.md)
...
```bash
cargo install --git https://github.com/IliasAlmerekov/aegis-shellguard --tag v0.6.6 aegis
```
