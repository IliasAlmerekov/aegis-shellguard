...
4. **Close the issue** (if applicable): when the work satisfies its acceptance criteria and verification is linked, close the issue. Write the PR description from `.github/pull_request_template.md`: 2-3 Summary bullets and the checklist. Session notes and verification details go in an issue comment.
